...
const UserProfileImg = user.photoURL || "src\assets\question-mark.png";
    ...
    <ul className="py-2" aria-labelledby="user-menu-button">
      <li>
        <a href={Siteroutes.DashBoard} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Dashboard</a>
      </li>
      <li>
        <a href={Siteroutes.Profile} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Profile</a>
      </li>
  <li>
