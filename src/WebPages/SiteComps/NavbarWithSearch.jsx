  ...
  return (
    <nav className="w-full bg-white dark:bg-blue-500 border-gray-200">
      ...
      <img src="real-estate-home-svgrepo-com.svg" className="h-8" alt="CampusNest Temp Logo" />
       ...
       <LoginButtonState />
             <button data-collapse-toggle="navbar-user" type="button" className="inline-flex items-center p-2 w-10 h-10 justify-right text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-user" aria-expanded="false">
